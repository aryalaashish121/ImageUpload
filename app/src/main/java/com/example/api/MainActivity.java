...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnloadHeroActivity = findViewById(R.id.am_bt_HeroActivity);

        btnloadHeroActivity.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent Load = new Intent(MainActivity.this, HeroActivity.class);
